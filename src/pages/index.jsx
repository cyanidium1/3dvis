          ...
          <Container>
            <div className="md:flex md:space-x-10 px-[24px]">
              <div className="h-full flex flex-col justify-between">
                ...
                <p className="font-extralight my-3">{pageContent?.descWhoI}</p>
          ...
          <Lightbox
            ...
            nextSrc={
              pageContent?.galleryPortfolio[
                (currentImageIndex + 1) % pageContent?.galleryPortfolio.length
              ].url
            }
            prevSrc={
              pageContent?.galleryPortfolio[
                (currentImageIndex + pageContent?.galleryPortfolio.length - 1) %
